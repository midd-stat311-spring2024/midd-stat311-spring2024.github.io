...
-   [Homework 2](weeks/hw/hw2.pdf) (due Tuesday, 2/29 at 11:59pm)
    -   **Note**: associated `R` problems can be found and completed in the following file: `.Rmd` template: {{< downloadthis weeks/hw/templates/hw2_r.Rmd dname="hw2_r.Rmd" label=".Rmd" icon="arrow-down-short" class=styled id=btn1 >}}
...
-   [Homework 4](weeks/hw/hw4.pdf) (due Tuesday, 3/12 at 11:59pm)
    -   **Note**: associated `R` problems completed in the following file: `.Rmd` template: {{< downloadthis weeks/hw/templates/hw4_r.Rmd dname="hw4_r" label=".Rmd" icon="arrow-down-short" class=styled id=btn1 >}}
